...
int XY2POS(int xx,int yy,int w, int h)
{
  ...
  void kernel mandelbrotImage2D(__write_only image2d_t entrada, sampler_t 
  ...
  void kernel mandelbrotVectorFloat(__global float * entrada,int maxinte,float zoom,float x_pos,float y_pos){
