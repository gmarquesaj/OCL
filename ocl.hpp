...
public:
  ...
  template <typename T>
  void SetarArgumentos(cl_uint index, const T &value)
  {
  ...
  template <typename T>
  cl::Buffer CriarBufferHOST(std::vector<T> &Vetor)
  {
  ...
  template <typename T>
  cl::Buffer CriarBuffer(std::vector<T> &Vetor)
  {
  ...
  template <typename T>
  cl::Buffer CriarBufferESCRITA(std::vector<T> &Vetor)
  {
